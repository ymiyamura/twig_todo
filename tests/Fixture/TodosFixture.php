...
class TodosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'descriptions' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'done' => '2018-09-16 21:24:48',
                'created' => '2018-09-16 21:24:48',
                'modified' => '2018-09-16 21:24:48'
            ],
        ];
        parent::init();
    }
